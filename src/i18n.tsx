...
const STRINGS = {
  pt: {
    ...
    micToggleLabel: "🎤 Cantar junto",
    micToggleHint: "Liga o microfone e desenha seu pitch em tempo real por cima das notas, pra comparar com a música (atalho: M). O áudio do microfone só é analisado aqui, nunca gravado nem enviado a lugar nenhum.",
    micPermissionDenied: "Não consegui acessar o microfone (permissão negada ou nenhum dispositivo encontrado).",
    revUndo: "↶ Desfazer",
    revRedo: "↷ Refazer",
  ...
  en: {
    ...
    micToggleLabel: "🎤 Sing along",
    micToggleHint: "Turns on the microphone and draws your live pitch over the notes, to compare against the song (shortcut: M). The mic audio is only analyzed here, never recorded or sent anywhere.",
    micPermissionDenied: "Couldn't access the microphone (permission denied or no device found).",
    revUndo: "↶ Undo",
    revRedo: "↷ Redo",
